...
export default function Navbar() {
  ...
  return (
    <header className="w-full flex items-center justify-between px-4 md:px-12 py-3.5 sticky top-0 z-50 bg-white/60 backdrop-blur-2xl border-b border-white/40 shadow-[0_8px_32px_0_rgba(31,38,135,0.05)]">
      {/* Brand Logo */}
      ...
      {/* Desktop Glass Capsule Navbar */}
      <nav className="hidden lg:flex items-center bg-white/40 backdrop-blur-3xl px-2.5 py-1.5 rounded-full shadow-[inset_0_1px_1px_rgba(255,255,255,0.6)] border border-white/60">
              ...
              >
                ...
                >
                  {isActive && (
                    <motion.div
                      layoutId="activePill"
                      className="absolute inset-0 bg-[#2997D0] rounded-full -z-10 shadow-[0_4px_16px_rgba(41,151,208,0.4)]"
                ...
                {/* Subtle Divider between nav items */}
                {index < navItems.length - 1 && (
                  <div className="h-4 w-[1px] bg-slate-300/40 mx-1" />
                )}
      ...
      {/* Mobile Menu Drawer with Frosted Glass */}
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
